...
func _process(delta: float) -> void:
	...
	if data.bats:
		$TabContainer/Accessibility/MarginContainer/HSplitContainer/Chiroptophobia.button_pressed = false
	else:
		$TabContainer/Accessibility/MarginContainer/HSplitContainer/Chiroptophobia.button_pressed = true
