...
func act(v:bool):
	...
	if v:
		...
		$TabContainer/Accessibility/MarginContainer/BoxContainer/Chiroptophobia.pressed = !data.bats
		$TabContainer/Accessibility/MarginContainer/BoxContainer/Hard.pressed = data.night
		$TabContainer/General/MarginContainer/VBoxContainer/Tutorials.pressed = data.tutorials
