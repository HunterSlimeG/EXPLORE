...
func _on_Fullscreen_item_selected(index: int) -> void:
	if $TabContainer/Video/MarginContainer/VBoxContainer/Fullscreen.get_item_index(0) == index:
		fullscreen_on = false
	if $TabContainer/Video/MarginContainer/VBoxContainer/Fullscreen.get_item_index(1) == index:
		fullscreen_on = true
...
func _on_resolution_item_selected(index: int) -> void:
	if $TabContainer/Video/MarginContainer/VBoxContainer/HSplitContainer/Resolution.get_item_index(480) == index:
		res = [854, 480]
	if $TabContainer/Video/MarginContainer/VBoxContainer/HSplitContainer/Resolution.get_item_index(720) == index:
		res = [1280, 720]
	if $TabContainer/Video/MarginContainer/VBoxContainer/HSplitContainer/Resolution.get_item_index(1080) == index:
		res = [1920, 1080]
	if $TabContainer/Video/MarginContainer/VBoxContainer/HSplitContainer/Resolution.get_item_index(1440) == index:
		res = [2560, 1440]
