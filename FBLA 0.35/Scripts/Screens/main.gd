...
func _on_room_left_room_send(r: Variant, rs: Array) -> void:
	if r.name == "Room T":
		$"Rooms/Split 2/Room End".spawn = true
		$"Rooms/Split 2/Room Up".spawn = true
	elif r.name == "Room Turn":
		$"Rooms/Split 2/Room Up".spawn = true
		$"Rooms/Split 2/Room End".spawn = false
	elif r.name == "Room Chest":
		$"Rooms/Split 2/Room Up".spawn = false
		$"Rooms/Split 2/Room End".spawn = false


func _on_room_right_room_send(r: Variant, rs: Array) -> void:
	if r.name == "Room T":
...
func _on_room_up_room_send2(r: Variant, rs: Array) -> void:
	if r.name == "Room T":
...
func _on_room_up_room_send3(r: Variant, rs: Array) -> void:
	if r.name == "Room T":
...
func _on_room_up_room_send5(r: Variant, rs: Array) -> void:
	if r.name == "Room T":
		$"Rooms/Split 7/Room End".spawn = true
	elif r.name == "Room Turn":
		$"Rooms/Split 7/Room End".spawn = false
	elif r.name == "Room Chest":
		$"Rooms/Split 7/Room End".spawn = false

func _on_room_up_room_send6(r: Variant, rs: Variant) -> void:
	if r.name == "Room T":
		$"Rooms/Split 7/Room End Alt".spawn = true
	elif r.name == "Room Turn":
		$"Rooms/Split 7/Room End Alt".spawn = false
	elif r.name == "Room Chest":
		$"Rooms/Split 7/Room End Alt".spawn = false
